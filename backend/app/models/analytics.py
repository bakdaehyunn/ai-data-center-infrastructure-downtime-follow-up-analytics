...
class DowntimeFollowUpQueue(TimestampMixin, Base):
    ...
    capacity_risk_score: Mapped[float] = mapped_column(Numeric(8, 2), nullable=False)
    redundancy_risk_score: Mapped[float] = mapped_column(Numeric(8, 2), nullable=False)
    thermal_risk_score: Mapped[float] = mapped_column(Numeric(8, 2), nullable=False)
    vendor_eta_risk_score: Mapped[float] = mapped_column(Numeric(8, 2), nullable=False)
    mitigation_credit_score: Mapped[float] = mapped_column(Numeric(8, 2), nullable=False)
