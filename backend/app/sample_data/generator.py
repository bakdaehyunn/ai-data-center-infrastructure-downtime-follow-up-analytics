...
def _generate_infrastructure_master_data() -> dict[str, list[dict[str, Any]]]:
    ...
    infrastructure_dependencies = [
        {
            "dependency_id": "DEP-RACK-PDU",
            "dependent_asset_id": "ASSET-RACK-01",
            "dependency_asset_id": "ASSET-PDU-01",
            "dependency_type": "POWER_PATH",
            "dependency_role": "PRIMARY",
            "impact_scope": "GPU_RACK",
            "source_system": INFRASTRUCTURE_SOURCE_SYSTEM,
            "metadata_json": {"path": "rack -> pdu"},
        },
        {
            "dependency_id": "DEP-PDU-UPS",
            "dependent_asset_id": "ASSET-PDU-01",
            "dependency_asset_id": "ASSET-UPS-01",
            "dependency_type": "POWER_PATH",
            "dependency_role": "PRIMARY",
            "impact_scope": "POWER_BRANCH",
            "source_system": INFRASTRUCTURE_SOURCE_SYSTEM,
            "metadata_json": {"path": "pdu -> ups"},
        },
        {
            "dependency_id": "DEP-UPS-SWGR",
            "dependent_asset_id": "ASSET-UPS-01",
            "dependency_asset_id": "ASSET-SWGR-01",
            "dependency_type": "POWER_PATH",
            "dependency_role": "PRIMARY",
            "impact_scope": "POWER_PATH",
            "source_system": INFRASTRUCTURE_SOURCE_SYSTEM,
            "metadata_json": {"path": "ups -> switchgear"},
        },
        {
            "dependency_id": "DEP-SWGR-GEN",
            "dependent_asset_id": "ASSET-SWGR-01",
            "dependency_asset_id": "ASSET-GEN-01",
            "dependency_type": "POWER_PATH",
            "dependency_role": "BACKUP",
            "impact_scope": "FACILITY_BACKUP_POWER",
            "source_system": INFRASTRUCTURE_SOURCE_SYSTEM,
            "metadata_json": {"path": "switchgear -> generator"},
        },
        {
            "dependency_id": "DEP-RACK-CRAH",
            "dependent_asset_id": "ASSET-RACK-01",
            "dependency_asset_id": "ASSET-CRAH-01",
            "dependency_type": "COOLING_PATH",
            "dependency_role": "PRIMARY",
            "impact_scope": "GPU_RACK",
            "source_system": INFRASTRUCTURE_SOURCE_SYSTEM,
            "metadata_json": {"path": "rack -> crah"},
        },
        {
            "dependency_id": "DEP-RACK-CDU",
            "dependent_asset_id": "ASSET-RACK-01",
            "dependency_asset_id": "ASSET-CDU-01",
            "dependency_type": "COOLING_PATH",
            "dependency_role": "SECONDARY",
            "impact_scope": "LIQUID_COOLING_LOOP",
            "source_system": INFRASTRUCTURE_SOURCE_SYSTEM,
            "metadata_json": {"path": "rack -> cdu"},
        },
        {
            "dependency_id": "DEP-CRAH-CHILLER",
            "dependent_asset_id": "ASSET-CRAH-01",
            "dependency_asset_id": "ASSET-CHILLER-01",
            "dependency_type": "COOLING_PATH",
            "dependency_role": "PRIMARY",
            "impact_scope": "COOLING_LOOP",
            "source_system": INFRASTRUCTURE_SOURCE_SYSTEM,
            "metadata_json": {"path": "crah -> chiller"},
        },
        {
            "dependency_id": "DEP-CDU-CHILLER",
            "dependent_asset_id": "ASSET-CDU-01",
            "dependency_asset_id": "ASSET-CHILLER-01",
            "dependency_type": "COOLING_PATH",
            "dependency_role": "PRIMARY",
            "impact_scope": "LIQUID_COOLING_LOOP",
            "source_system": INFRASTRUCTURE_SOURCE_SYSTEM,
            "metadata_json": {"path": "cdu -> chiller"},
        },
    ]
    return {
